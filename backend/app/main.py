...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://127.0.0.1:3000","https://plum-opd-adjudication.vercel.app",  # Your main Vercel domain
        "https://plum-opd-adjudication-dk4eisjee-vsn20s-projects.vercel.app"],
